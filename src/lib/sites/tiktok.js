...
(function (root, factory) {
   ...
   *
   * Берём `playAddr`, а не `downloadAddr`. `playAddr` — тот самый файл, что
   * страница уже проигрывает, и он достаётся нам без единого лишнего запроса.
   * `downloadAddr` — отдельный файл, пересобранный площадкой, за которым
   * пришлось бы идти самим, а своих запросов расширение не делает.
   */
